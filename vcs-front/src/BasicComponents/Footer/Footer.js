...
export default function Footer() {
    return (
        <footer className="text-white justify-content-center bg-default">
            <ul className="footer-list-item-inline">

                <li className="list-inline-item"><button data-bs-toggle="modal" data-bs-target="#AddItemModal" className="btn home-btn"><svg
                ...
                <li className="list-inline-item"><button className="btn home-btn " data-bs-toggle="offcanvas" data-bs-target="#sidebar" aria-controls="sidebar">
                ...
                <li className="list-inline-item"><a href="" className="btn home-btn "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <li className="list-inline-item">
                    <button className="btn home-btn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bookmark-star"
                            viewBox="0 0 16 16">
                            <path
