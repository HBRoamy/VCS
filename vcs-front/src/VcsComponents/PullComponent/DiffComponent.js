                    ...
                    <div className="mt-4">
                        {mergedLines.length > 0 ? (
                            <>
                                ...
                                {
                                    isMergeable ? (
                                        <div className='card car-body bg-dark text-light font-montserrat'>
